...
class TrashDetectionPage extends StatefulWidget {
  const TrashDetectionPage({super.key});

  @override
  _TrashDetectionPageState createState() => _TrashDetectionPageState();
}

class _TrashDetectionPageState extends State<TrashDetectionPage> {
  File? _image;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Trash Detection', style: TextStyle(color: Colors.white)),
